# Generated by Django 2.0.4 on 2018-07-10 12:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.FileField(default='portrait/default.jpg', upload_to='portrait/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=32)),
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.BlogTheme')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='theme',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='blog.BlogTheme'),
        ),
        migrations.AddField(
            model_name='userinfo',
